...
const REQUIRED: Record<string, string[]> = {
  ...
  vehicle_handoffs: ["id", "vehicle_id", "delivery_agent_id", "source_warehouse_id", "vehicle_warehouse_id", "handoff_date", "status", "labels_printed_at", "labels_printed_by", "handed_over_at", "handed_over_by", "stock_transferred_at", "stock_transferred_by", "cancelled_at", "cancelled_by", "movement_reference", "operation_key", "request_fingerprint", "prepared_actor_type", "prepared_actor_ref", "notes", "created_at"],
