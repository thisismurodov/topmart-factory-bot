                  ...
                  {currentTargets.map((target) => (
                    <Card key={target.id} className={target.low ? "border-amber-200" : ""}>
                      <CardContent className="space-y-3 p-4">
                        ...
                        <div className="grid grid-cols-3 gap-2 text-center text-sm"><div className="rounded bg-slate-50 p-2"><span className="block text-xs text-slate-500">Joriy</span><b>{target.currentQuantity}</b></div><div className="rounded bg-slate-50 p-2"><span className="block text-xs text-slate-500">Min</span><b>{target.minQuantity}</b></div><div className="rounded bg-slate-50 p-2"><span className="block text-xs text-slate-500">Maqsad</span><b>{target.targetQuantity}</b></div></div>
                      ...
                      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                        <div className="min-w-0 space-y-2">
                          ...
                          <div className="grid grid-cols-2 gap-x-6 gap-y-1 text-sm sm:grid-cols-4">
                            <span><span className="text-slate-500">So‘ralgan:</span> <b>{request.requestedQuantity}</b></span>
                            <span><span className="text-slate-500">Joriy surat:</span> {request.currentQuantitySnapshot}</span>
                            <span><span className="text-slate-500">Maqsad surat:</span> {request.targetQuantitySnapshot}</span>
