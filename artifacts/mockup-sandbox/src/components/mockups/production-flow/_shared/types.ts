// Types for the F1 Production Flow fixture — mirrors the proposed
// GET /ombor/flow/graph response shape (read-only).
...
export interface GraphFixture {
  ...
  regionalGroup: { name: string; count: number; kg: number; dona: number; list: ContainerData[] } | null;
