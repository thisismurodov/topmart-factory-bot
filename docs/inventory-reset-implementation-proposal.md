...
| R-D | Baseline yuklash — **SHART: tekshirilgan R-A** | konteyner-kesim BASELINE harakatlar + inventar (C-16/C-17'da 13 legacy qator ham auditli BASELINE bilan nollanadi) | ✅ **TO'LIQ BAJARILDI 2026-08-17**: C-15 (`docs/r-d-c15-execution-report-2026-08-17.md`) + «R-D FINAL GO» bilan qolgan 8 konteyner + 2 EXACT (`docs/r-d-final-execution-report-2026-08-17.md`) — 9/9 LOADED, 110 BASELINE, 71 862.20 kg / 126 360 dona, 13 legacy nollandi |
...
*Holat 2026-08-17 (R-D YAKUN): «R-D FINAL GO» BAJARILDI — barcha 9 lokatsiya LOADED. Joriy inventar = fizik sanoq aynan: 110 BASELINE harakat, 140 inventar satri, 71 862.20 kg / 126 360 dona; tasnif 6 raw / 3 pre-finished / 88 finished (FINAL MASTER PROMPT §21); 13 legacy qator (C-16: 3, C-17: 10) auditli BASELINE bilan nollandi (№2 HAL — egasi FINAL GO tarkibida tasdiqladi); 2 EXACT mavjud katalogga biriktirildi (id=46 Rossiya Tros → C-18 531.00 kg, id=108 Shroki 3.5 Oq → C-02 676.55 kg; yangi SKU yo'q, item_id NULL, registr pozitsiyalari EXCLUDED muzlatilgan — №1 HAL). Mustaqil read-only post-verify 13/13 PASS — `docs/r-d-final-execution-report-2026-08-17.md`. Ochiq: №3 (C-15 maqsadi, R-E), №4 (WIP kesimi — endi qaror uchun tayyor), №7, hamda §17–18 UI bosqichi (pre-finished ko'rinishi) — hech biri avto-boshlanmaydi.*
