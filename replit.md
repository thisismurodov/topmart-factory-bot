...
- Field Assistant navigatsiya: faqat Yandex Maps deep-link (`NavButtons.tsx`) — agent so'roviga ko'ra radarlar/kameralar/tezlik uchun (2026-07-15; oldin Google/Yandex/Waze/Apple 4 tugma edi). Dashboard `GeoNavLinks` o'zgarmagan.
